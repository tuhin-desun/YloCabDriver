...
import {startTrip, cancelTrip, getDriverProfile} from "../services/APIServices";
import Header from "../component/Header";
import getDirections from 'react-native-google-maps-directions';


export default function StartTripScreen(props) {
        ...
        startTrip(booking)
            .then((response)=>{
                if(response.type == "success"){
                    booking.booking_request_id = response.request_id
