                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: 'transparent' }}>
                    <View style={styles.container}>
                        ...
                        <Animated.View style={[styles.section, { height: coverHeight }]}>
                            ...
                            >
                                Ylo Driver collects location data when the app is closed or not in use, So that on duty driver can get booking from nearest user, also to track position of the car when driver is on duty. Location tracking stops when driver is not active and changes status of duty from within the app.
                            </Animated.Text>
